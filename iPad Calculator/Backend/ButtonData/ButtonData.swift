...
struct ButtonData: Identifiable, Hashable, ExpressibleByNilLiteral, Codable {
    ...
    var command: String {
        enteredCommand.isEmpty ? name : enteredCommand
    }
...
enum ButtonColor: String, CaseIterable, Codable, Identifiable {
    case action = "Action"
    case number = "Number"
...
enum ButtonIcon: String, CaseIterable, Codable, Identifiable {
    case none = "None"
